...
import { extractPlainNarration } from '@/lib/narration'
import type { ParsedGradedChapter } from '@/lib/parseGradedChapter'
...
type Props = {
  ...
  chapter: ParsedGradedChapter
}

export function GradedReaderClient({ novelId, novelTitle, chapterNum, availableChapters, chapter }: Props) {
  ...
  const narrationSegments = extractPlainNarration(chapter.storyLines)
