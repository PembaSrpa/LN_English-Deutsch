        ...
        <div className="grid grid-cols-2 gap-3">
          {novelData.map(({ novel, chapterCount }) => (
            <Link key={novel.id} href={`/${novel.id}`}
              className="group border border-neutral-300 dark:border-neutral-700 rounded-2xl overflow-hidden hover:border-neutral-400 dark:hover:border-neutral-600 transition-all bg-neutral-100 dark:bg-neutral-800">
              <div className="aspect-[2/3] relative overflow-hidden bg-neutral-300 dark:bg-neutral-700">
                {novel.coverImage
                  ? <img src={novel.coverImage} alt={novel.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
